...
1. `DATAPREFIX_expr.txt` (or `DATAPREFIX_expr_h5` for larger datasets):  a $N$-by-$M$ matrix of gene/transcript expression values where $N$ and $M$ are the numbers of cells and features, respectively 
